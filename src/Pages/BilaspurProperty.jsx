    ...
    <div className="container mx-auto px-4 py-8">
      <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-12">
        ...
        <div className="relative h-96">
          <img
            src="/src/assets/images/bilaspur1.jpg"
            alt="Hotel Highway King Bilaspur"
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-center items-center p-8 z-20">
            <h1 className="text-white text-4xl font-bold leading-tight text-center">Hotel Highway King Bilaspur</h1>
        ...
        <div className="p-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8"> 
            ...
            <div className="lg:col-span-2" id="about">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">About Hotel Highway King Bilaspur</h2>
              <p className="text-gray-600 mb-6">
                Situated in the heart of Bilaspur, our hotel offers the perfect blend of traditional Rajasthani
...
export default BilaspurProperty;