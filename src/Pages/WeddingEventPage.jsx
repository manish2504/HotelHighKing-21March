        ...
        <div className="bg-gradient-to-r from-yellow-400 to-red-600 text-white py-16">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-5xl font-bold mb-6">Wedding Event</h1>
      ...
      <div className="container mx-auto px-6 pt-24 pb-16">
        <div className="text-center mb-16 pt-8">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">
            Unforgettable Wedding Events Tailored to Perfection
          </h2>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row">
            <div className="md:w-1/2 md:pr-8 mb-8 md:mb-0">
              ...
              <p className="text-blue-100 text-lg mb-6">Let Hotel Highway King  Elevate Your Wedding Event Experience!</p>
