...
const HeroSection = () => (
  <div className="relative h-96 bg-cover bg-center" style={{ backgroundImage: `url(${shahpuraImage})` }}>
    ...
    <div className="relative container mx-auto px-6 h-full flex flex-col justify-center text-center">
      ...
      <p className="text-lg text-white text-shadow-xl mb-6">
        A place where comfort meets luxury in the heart of Shahpura.
      </p>
    </div>
  </div>
);
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="flex flex-col md:flex-row items-center justify-between bg-gray-200 p-8 mb-16 rounded-2xl shadow-lg border-4 border-yellow-500">
          <div className="w-full md:w-1/2 pr-0 md:pr-8 mb-6 md:mb-0">
            <h2 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 via-orange-400 to-red-600 mb-6">
              Welcome to Hotel Highway King Shahpura
            </h2>

            <p className="text-lg text-gray-600">
              Hotel Highway King Shahpura is a premium destination offering top-notch facilities and services to ensure an unforgettable stay. We are proud to provide a luxurious experience for both business and leisure travelers.
              <br /><br />
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-16">
          <div className="p-8">
            ...
            <p className="text-gray-600 mb-4">Find us in the heart of Shahpura</p>
          </div>
          <iframe
            src="https://www.google.com/maps?q=27.91464120559464, 76.31494690388533&hl=en&z=15&output=embed"
            width="100%" height="400" frameBorder="0" style={{ border: 0 }} allowFullScreen=""
            aria-hidden="false" tabIndex="0"
            title="Hotel Highway King Shahpura Location"
          ></iframe>
        </div>
